-- ELMS Complete Database Schema
-- This file contains all tables with correct structure and sample data
-- No errors, ready to import directly
...
-- Courses table (complete with all columns)
...
INSERT INTO `teacher_details` (`teacher_id`, `qualification`, `experience`, `specialization`, `bio`, `linkedin`, `website`) 
...
INSERT INTO `admin_details` (`admin_id`, `department`, `position`, `permissions`) 
VALUES (1, 'IT Administration', 'System Administrator', '["all"]');

-- Insert student details
INSERT INTO `student_details` (`student_id`, `date_of_birth`, `gender`, `education_level`, `institution`) 
VALUES (3, '2000-05-15', 'female', 'Bachelor\'s Degree', 'University of Technology');

-- Insert sample courses (FIXED - with all required columns)
INSERT INTO `courses` (`title`, `description`, `instructor_id`, `category`, `level`, `price`, `is_premium`, `total_lessons`, `status`) 
VALUES 
...
INSERT INTO `lessons` (`course_id`, `title`, `description`, `video_url`, `reading_material`, `duration`, `order_number`, `is_free`, `status`) 
VALUES 
...
INSERT INTO `quizzes` (`course_id`, `title`, `description`, `passing_score`, `time_limit`, `total_questions`, `status`) 
VALUES 
...
INSERT INTO `quiz_questions` (`quiz_id`, `question`, `option_a`, `option_b`, `option_c`, `option_d`, `correct_answer`, `points`, `explanation`) 
VALUES 
...
INSERT INTO `bounty_points` (`student_id`, `points`, `source`, `description`) 
VALUES 
...
INSERT INTO `quiz_attempts` (`student_id`, `quiz_id`, `score`, `total_questions`, `correct_answers`, `passed`) 
VALUES 
(3, 1, 80, 3, 3, TRUE),
(3, 3, 85, 1, 1, TRUE);
...
INSERT INTO `payments` (`student_id`, `course_id`, `amount`, `payment_method`, `transaction_id`, `status`) 
VALUES 
(3, 1, 2999.00, 'credit_card', 'TXN20241201001', 'completed');

-- Insert sample live classes
INSERT INTO `live_classes` (`course_id`, `title`, `description`, `meeting_url`, `scheduled_at`, `duration`, `max_participants`) 
VALUES 
...
INSERT INTO `attendance` (`student_id`, `course_id`, `lesson_id`, `status`, `marked_by`) 
VALUES 
(3, 2, 1, 'present', 2),
(3, 2, 2, 'present', 2),
(3, 1, 1, 'present', 2);
...
VALUES 
('John Doe', 'john@example.com', 'Course Inquiry', 'I would like to know more about the web development course.'),
('Jane Smith', 'jane@example.com', 'Technical Support', 'I am having trouble accessing the course materials.');
...
SELECT 'ELMS Database created successfully with all tables and sample data!' as message; 