...
<div class="row">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="lessons_coming_soon.php">
                        ...
                        Lessons <span class="badge bg-secondary ms-2">Coming Soon</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="quizzes_coming_soon.php">
                        <i class="fas fa-question-circle me-2"></i>
                        Quizzes <span class="badge bg-secondary ms-2">Coming Soon</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="live_classes_coming_soon.php">
                        <i class="fas fa-video me-2"></i>
                        Live Classes <span class="badge bg-secondary ms-2">Coming Soon</span>
                    </a>
                </li>
                <li class="nav-item">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 dashboard-main-content d-flex align-items-center justify-content-center" style="min-height: 80vh;">
        <div class="text-center">
            ...
            <h2 class="fw-bold">Notifications - Coming Soon</h2>
