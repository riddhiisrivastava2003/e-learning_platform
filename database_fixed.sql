-- ELMS Complete Database Schema - FIXED VERSION
...
-- Insert sample teacher (IGNORE duplicates)
INSERT IGNORE INTO `users` (`username`, `email`, `password`, `full_name`, `role`, `status`) 
...
-- Insert sample student (IGNORE duplicates)
INSERT IGNORE INTO `users` (`username`, `email`, `password`, `full_name`, `role`, `status`) 
...
-- Insert teacher details (IGNORE duplicates)
...
-- Insert admin details (IGNORE duplicates)
...
-- Insert student details (IGNORE duplicates)
...
-- Insert sample courses (IGNORE duplicates - with all required columns)
...
-- Insert sample lessons for Web Development course (IGNORE duplicates)
...
-- Insert sample lessons for Data Science course (IGNORE duplicates)
INSERT IGNORE INTO `lessons` (`course_id`, `title`, `description`, `video_url`, `reading_material`, `duration`, `order_number`, `is_free`, `status`) 
VALUES 
...
-- Insert sample quizzes (IGNORE duplicates)
...
-- Insert sample quiz questions (IGNORE duplicates)
...
-- Insert sample enrollments (IGNORE duplicates)
...
-- Insert sample bounty points (IGNORE duplicates)
...
-- Insert sample live classes (IGNORE duplicates)
...
-- Insert sample attendance (IGNORE duplicates)
...
-- Insert sample notifications (IGNORE duplicates)
...
-- Insert system settings (IGNORE duplicates)
...
-- Insert sample contact messages (IGNORE duplicates)
...
SELECT 'Welcome to EduTech Pro!' as message; 