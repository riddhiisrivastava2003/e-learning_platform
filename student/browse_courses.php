        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 dashboard-main-content">
                <div class="d-flex justify-content-between align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h2 class="h3">Browse Courses</h2>
                    <form class="d-flex" id="browseCoursesSearchForm">
                        <input class="form-control me-2" type="search" placeholder="Search courses..." aria-label="Search" id="browseCoursesSearchInput">
                ...
                <div class="row" id="browseCoursesList">
                    <?php if (empty($availableCourses)): ?>
                        <div class="col-12 text-center py-5">
                            ...
                            <h5 class="text-muted">No courses available to enroll</h5>
                        </div>
                    <?php else: ?>
