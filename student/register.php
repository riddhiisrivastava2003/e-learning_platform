...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        ...
        $stmt = $pdo->prepare("INSERT INTO users (username, email, password, full_name, phone, role) VALUES (?, ?, ?, ?, ?, 'student')");
...
<head>
    ...
    <title>Student Registration - EduTech Pro</title>
    ...
    <div class="register-container">
        ...
        <div class="register-card">
            <div class="register-header">
                ...
                <p class="mb-0">Join our learning community and start your journey</p>
            </div>
