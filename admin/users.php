...
// Fetch all students
$stmt = $pdo->prepare("SELECT u.*, GROUP_CONCAT(DISTINCT c.title SEPARATOR ', ') as courses
    FROM users u
...
<head>
    ...
    <title>Manage Users - Admin | EduTech Pro</title>
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlspecialchars($student['status'] ?? 'active'); ?></td>
                                            <td><?php echo htmlspecialchars($student['courses'] ?: 'None'); ?></td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlspecialchars($teacher['status'] ?? 'active'); ?></td>
                                            <td><?php echo htmlspecialchars($teacher['courses'] ?: 'None'); ?></td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
